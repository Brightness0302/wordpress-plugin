...
?>
<!DOCTYPE html>
<!-- saved from url=(0043)https://html5up.net/uploads/demos/fractal/# -->
<html>
<head>
    ...
    <style>
        ...
        *:after {
        ...
        .wrapper.style1 .image.phone .inner,
        .wrapper.style1 .image.phone:before,
        .wrapper.style1 .image.phone:after {
        border-color: rgba(255, 255, 255, 0.25);
        }
        ...
        .wrapper.style3 .image.phone .inner,
        .wrapper.style3 .image.phone:before,
        .wrapper.style3 .image.phone:after {
        border-color: #d6d6d6;
        }
        ...
        -ms-justify-content: center;
        justify-content: center;
        background-image: url("https://html5up.net/uploads/demos/fractal/assets/css/images/overlay.png"),
            url("https://html5up.net/uploads/demos/fractal/assets/css/images/pattern-size1.svg");
        ...
        #header {
            background-image: url("https://html5up.net/uploads/demos/fractal/assets/css/images/overlay.png"),
            url("https://html5up.net/uploads/demos/fractal/assets/css/images/pattern-size2.svg");
        }
        }
        ...
        #header {
            background-image: url("https://html5up.net/uploads/demos/fractal/assets/css/images/overlay.png"),
            url("https://html5up.net/uploads/demos/fractal/assets/css/images/pattern-size3.svg");
        }
	...
	<!-- Header -->
		<header id="header">
			<div class="content">
				...
				<ul class="actions">
					<li><a href="https://html5up.net/uploads/demos/fractal/#" class="button primary icon solid fa-download">Download</a></li>
					<li><a href="https://html5up.net/uploads/demos/fractal/#one" class="button icon solid fa-chevron-down scrolly">Learn More</a></li>
				</ul>
			</div>
			<div class="image phone"><div class="inner"><img src="https://html5up.net/uploads/demos/fractal/images/screen.jpg" alt=""></div></div>
		</header>
